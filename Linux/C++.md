...
C++是一种系统编程语言。用它的发明者，
[Bjarne Stroustrup 的话](http://channel9.msdn.com/Events/Lang-NEXT/Lang-NEXT-2014/Keynote)来说，C++的设计目标是：
...
C++提供了对硬件的紧密控制（正如 C 语言一样），
能够编译为机器语言，由处理器直接执行。
与此同时，它也提供了泛型、异常和类等高层功能。
虽然 C++的语法可能比某些出现较晚的语言更复杂，它仍然得到了人们的青睞——
功能与速度的平衡使 C++成为了目前应用最广泛的系统编程语言之一。
